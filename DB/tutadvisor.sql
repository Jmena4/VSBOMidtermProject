...
START TRANSACTION;
USE `tutadvisordb`;
INSERT INTO `learnable_skill` (`learnable_id`, `user_id`, `skill_name_id`, `skill_level_id`, `comment`) VALUES (1, 1, 3, 1, 'This will be more fun than licking cold door knobs!');
INSERT INTO `learnable_skill` (`learnable_id`, `user_id`, `skill_name_id`, `skill_level_id`, `comment`) VALUES (2, 2, 1, 1, 'Can I feed them after midnight?');
INSERT INTO `learnable_skill` (`learnable_id`, `user_id`, `skill_name_id`, `skill_level_id`, `comment`) VALUES (3, 3, 2, 1, 'I cried during Jerry McGuire');
...
START TRANSACTION;
USE `tutadvisordb`;
INSERT INTO `teachable_skill` (`teachable_id`, `user_id`, `skill_name_id`, `skill_level_id`, `comment`) VALUES (1, 1, 1, 1, 'I grow my own');
INSERT INTO `teachable_skill` (`teachable_id`, `user_id`, `skill_name_id`, `skill_level_id`, `comment`) VALUES (2, 2, 2, 2, 'So... illogical');
INSERT INTO `teachable_skill` (`teachable_id`, `user_id`, `skill_name_id`, `skill_level_id`, `comment`) VALUES (3, 3, 3, 3, 'PhD from StarFleet Academy');
