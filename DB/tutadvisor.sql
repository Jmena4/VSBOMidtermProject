...
START TRANSACTION;
USE `tutadvisordb`;
INSERT INTO `learnable_skill` (`learnable_id`, `user_id`, `skill_name_id`, `skill_level_id`, `comment`, `is_active`) VALUES (1, 1, 3, 1, 'This will be more fun than licking cold door knobs!', 1);
INSERT INTO `learnable_skill` (`learnable_id`, `user_id`, `skill_name_id`, `skill_level_id`, `comment`, `is_active`) VALUES (2, 2, 1, 1, 'Can I feed them after midnight?', 1);
INSERT INTO `learnable_skill` (`learnable_id`, `user_id`, `skill_name_id`, `skill_level_id`, `comment`, `is_active`) VALUES (3, 3, 2, 1, 'I cried during Jerry McGuire', 1);
INSERT INTO `learnable_skill` (`learnable_id`, `user_id`, `skill_name_id`, `skill_level_id`, `comment`, `is_active`) VALUES (4, 2, 3, 4, 'test?', 1);
